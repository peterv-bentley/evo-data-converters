...
def _create_continuous_attribute(
    ...
    mask: npt.NDArray[np.bool_] | None,
    grid_is_filtered: bool,
) -> Dict[str, Any]:  # ContinuousAttribute_V1_1_0:
    ...
    return dict(name=name, values=table, type="continuous")
...
def _create_integer_attribute(
    ...
    mask: npt.NDArray[np.bool_] | None,
    grid_is_filtered: bool,
) -> Dict[str, Any]:  # IntegerAttribute_V1_1_0:
    values = vtk_to_numpy(array)
    ...
    print("create integer attribute", table)
    return dict(name=name, values=table, type="integer")
...
def _create_categorical_attribute(
    ...
    mask: npt.NDArray[np.bool_] | None,
    grid_is_filtered: bool,
) -> Dict[str, Any]:  # CategoryAttribute_V1_1_0:
    ...
    return dict(name=name, table=lookup_table, values=values_table, type="category")


def convert_attributes_to_grid(
